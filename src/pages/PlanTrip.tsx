      ...
      <section className="relative h-[40vh] min-h-[350px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
          ...
          <p className="text-lg text-primary-foreground/90 max-w-2xl mx-auto">
            Let's create your dream Sri Lankan adventure together
          </p>
        </div>
      </section>
      ...
      <Section>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-12">
            Contact us directly through any of these channels. Tell us about your travel dates, interests, and group size - we'll craft the perfect itinerary for you!
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            ...
            {/* Email */}
            <a
              href={`mailto:${email}?subject=Trip%20Inquiry`}
